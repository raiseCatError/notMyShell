...
- Rich Git state (staged, modified, untracked, conflicts, ahead/behind/diverged, operations, clean) colored Semantic by default, or Follow theme / Grayscale: `/prompt` → Rich Git
